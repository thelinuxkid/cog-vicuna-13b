...
def download_hf_model_and_copy_tokenizer(
    ...
    # if not model_path:
    #     model_path = os.path.join(os.getcwd(), "models", model_name, "hf")
    ...
    config_path = os.join(model_path, "config.json")
...
if __name__ == "__main__":
    ...
    if args.tensorize:
        model = tensorize_model(args.model_name, dtype=args.dtype)
